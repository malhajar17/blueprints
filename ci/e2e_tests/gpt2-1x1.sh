...
TRAINING_NAME=gpt2-1x1-e2e-$TRAINING_SUFFIX
flexai training run $TRAINING_NAME -D ci-gpt2-tokenized-wikitext -s $SOURCE -r $TRAINING_REVISION -- code/causal-language-modeling/train.py \
    --do_eval \
    --do_train \

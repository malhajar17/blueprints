...
flexai training run $TRAINING_NAME -D ci-sdxl-tokenized-naruto -u $SOURCE -b $TRAINING_REVISION -S HF_TOKEN=GC_HF_TOKEN -S WANDB_API_KEY=GC_WANDB_API_KEY -E WANDB_PROJECT=ci-e2e -- code/diffuser/train_text_to_image_lora_sdxl.py \

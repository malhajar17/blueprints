...
flexai training run $TRAINING_NAME -D ci-text-to-speech-fr -s $SOURCE -r $TRAINING_REVISION -S WANDB_API_KEY=GC_WANDB_API_KEY -E WANDB_PROJECT=ci-e2e -- code/text-to-speech/run_parler_tts_training.py \
